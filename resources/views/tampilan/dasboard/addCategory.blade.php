        ...
        <div class="col-lg-8">
            <form method="POST" action="/dashboard/category" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('category') is-invalid @enderror" id="category" name="category" placeholder="Enter Your category" value="{{ old('category') }}" id="category" required>
                    @error('category')
                ...
                <button type="submit" name="submit" class="btn btn-primary mb-5">Create Category</button>
              </form>
        </div>
    </div>
