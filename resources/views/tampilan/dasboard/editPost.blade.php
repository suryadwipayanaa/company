...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h4><span data-feather="plus"></span> Edit Post</h4>
    </div>
    <div class="row">
        <div class="col-lg-8">
            <form method="POST" action="/dashboard/blogs/{{ $blog->slug }}" enctype="multipart/form-data">
              @method('put')
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" placeholder="Enter Your Title" value="{{ old('title', $blog->title) }}" id="title" required>
                    @error('title')
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" name="category_id" required>
                    ...
                    @if(old('category_id', $blog->category_id) == $cate->id)
                ...
                <div class="mb-3">
                  ...
                  <div class="row">
                    <div class="col-sm-12 col-md-6">
                      <img class="preview img-fluid mb-2" src="{{ asset('storage/' . $blog->image) }}">
                    </div>
                  </div>
                ...
                <div class="mb-3">
                  ...
                  @error('desFull')
                    {{ $message }}
                  @enderror
                    <input id="desFull" type="hidden" name="desFull" required value="{{ old('desFull', $blog->desFull) }}">
                    <trix-editor input="desFull"></trix-editor>
                </div>
                <button type="submit" name="submit" class="btn btn-primary mb-5">Update Post</button>
              </form>
        </div>
    </div>
