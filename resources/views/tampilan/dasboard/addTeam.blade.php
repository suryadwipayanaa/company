...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h4><span data-feather="plus"></span> Add New Team</h4>
    </div>
    <div class="row">
        <div class="col-lg-8">
            <form method="POST" action="/dashboard/teams" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('level') is-invalid @enderror" id="level" name="level" placeholder="Enter Your Price" required value="{{ old('level') }}">
                    @error('level')
                    <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="datetime-local" class=" @error('join') is-invalid @enderror" id="join" name="join" required value="{{ old('join') }}">
                    @error('join')
                    <div class="invalid-feedback">
                        {{ $message }}
                      </div>
